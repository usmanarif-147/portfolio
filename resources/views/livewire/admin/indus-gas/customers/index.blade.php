<div>
    ...
    <div class="bg-dark-800 border border-dark-700 rounded-xl overflow-hidden">
                    ...
                    @forelse ($customers as $customer)
                        <tr class="hover:bg-dark-700/30 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right"><div class="flex items-center justify-end gap-2">
                                ...
                                <x-admin.confirm-button title="Delete Customer?" text="This customer will be permanently removed." action="$wire.delete({{ $customer->id }})" confirm-text="Yes, delete it" class="text-gray-400 hover:text-red-400 transition-colors p-1">
        ...
        @if ($customers->hasPages())<div class="px-6 py-4 border-t border-dark-700">{{ $customers->links() }}</div>@endif
    </div>
</div>
